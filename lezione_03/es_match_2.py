...
il proprio genere (specificato con "m" per maschio o "f" per femmina) e utilizzi lo statement match per fornire una risposta adeguata 
...
gen = str(input("Inserisci il genere (f/m): "))
...
match gen:
    ...
    case ("f"):
        print(f"Nome: {nome} \nGenere: Femmina")
    case ( _):
        print(f"Mi dispiace {nome}, non è possibile generare un documento di identità!")
